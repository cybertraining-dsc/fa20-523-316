...
In this section, we present the results of the data analysis performed over the course of the study.After all the data was collected, we have formatted the candidate's information and cleaned the Twitter data. After closely watching the Twitter data
